...
class TestHilbertAwareMultiScaleAttentionConfig:
    ...
    def test_hierarchical_scale_bounds_from_config(self, dim, heads, max_level):
    ...
    def test_default_config_when_none(self, dim, heads, max_level):
        """未提供配置时使用默认配置."""
        attn = HilbertAwareMultiScaleAttention(
            dim=dim,
            heads=heads,
    ...
    def test_get_config_method(self, dim, heads, max_level):
        """get_config 方法返回配置."""
