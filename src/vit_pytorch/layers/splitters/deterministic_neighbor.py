...
class DeterministicNeighborSplitter(
    ...
    def _roi_align(
        ...
        normalized[:, 0] = 2.0 * regions[:, 0] / w - 1.0
        normalized[:, 1] = 2.0 * regions[:, 1] / h - 1.0
        ...
        return torch.cat(roi_features_list, dim=0)
